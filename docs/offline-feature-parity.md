...
| **80mm Receipts & WhatsApp Sharing** | A4/thermal receipts and WhatsApp share prompts. | Invoice and repair detail pages support A4 print, 80mm browser print, and WhatsApp Web share links. | **Partially Aligned** | Direct ESC/POS printing, return detail receipts, and daily closing 80mm summaries are planned. |
