...
* **Current production main SHA:** `c73853a8902a980cb910540710d9a8039f494a40`
* **Immediate previous safe rollback point:** `fd388f2ce5d1dd33718dc9c183289a7b25db320c`
* **Live URLs:**
  * https://saledock.site
...
12. **reCAPTCHA Audit:** Investigated warning. No auth logic changes were made. Standard reCAPTCHA v2 checkbox on login was kept untouched. Unused Enterprise key should be managed/deleted in Google Cloud Console.
...
1. **Walkthrough:** Conduct a final walkthrough with Fardan on mobile to verify POS sale, plain-text WhatsApp share, print, logo upload, customize bottom tabs, cash drawer closing, and reports.
2. **Small Polish:** Address any minor layout issues only if reported by Fardan.
