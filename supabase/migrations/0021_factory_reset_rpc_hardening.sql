-- Migration 0021: Harden reset_organization_to_factory_defaults
-- 1. Add set search_path = public to the security definer function
-- 2. Add auth.uid() check inside function body
-- 3. Explicitly revoke execute from public/anon, grant to authenticated/service_role

-- Supersedes migration 0017's function definition.
