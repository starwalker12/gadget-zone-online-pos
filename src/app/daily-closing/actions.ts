    ...
    .upsert(
      {
        ...
        credit_collection_cash: activity.creditCollectionCash,
        credit_collection_digital: activity.creditCollectionDigital,
        credit_write_offs: activity.creditWriteOffs,
