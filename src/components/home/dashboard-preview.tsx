...
export type KPI = { label: string; value: string; change: string; color: string };
export type Row = { icon: React.ComponentType<{ className?: string }>; left: string; right: string; color: string; bg: string };
export type Bar = { day: string; v: number };
